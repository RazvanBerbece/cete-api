 ...
 * 
 */
import { Request, Connection, TYPES } from "tedious";
...
class DBClient {
    ...
    private executeSQL: (query: any, params: any) => Promise<unknown>;
    ...
    constructor() {
        ...
        this.executeSQL = (query, params) => new Promise(
            (resolve, reject) => {
     ...
     */
    existsInCeteIndexing(id: string) {
