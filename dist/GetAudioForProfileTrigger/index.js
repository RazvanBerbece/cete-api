    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof userId === 'undefined' || typeof archived === 'undefined') {
            context.res = {
                ...
                body: new Response_js_1.default(new Date().toLocaleString(), '/api/v1/get/audio', { message: `InvalidRequestNoUIDOrVisibility : GET Request has no UID or visibility query parameter` }),
                headers: {
            ...
            const cetesDownloadResult = yield blobClient.downloadCetesDataForUserIdFromWAVBlob(userId, (archived === 'true'), limitCount); // convert 'archive' var to a boolean
            if (cetesDownloadResult instanceof Error) {
                context.res = {
                    status: statuses_js_1.default.SERVER_GET_AUDIO_METADATA_FROM_UID_BLOB,
                    body: new Response_js_1.default(new Date().toLocaleString(), '/api/v1/get/audio', { message: `ServerErrorGetFromUIDBlobs : ${cetesDownloadResult.message}. GET Request has downloaded no data.` }),
                    headers: {
                        'Content-Type': 'application/json'
                    }
                };
                ...
                context.res = {
                    ...
                    body: new Response_js_1.default(new Date().toLocaleString(), '/api/v1/get/audio', {
